...
export class UserLayoutComponent {
    ...
    static { this.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: UserLayoutComponent, selectors: [["app-user-layout"]], standalone: true, features: [i0.ɵɵStandaloneFeature], decls: 76, vars: 19, consts: [["userMenu", "matMenu"], [1, "app-shell"], [1, "sidebar"], [1, "sidebar-header"], [1, "logo"], [1, "logo-icon"], [1, "material-icons-round"], [1, "logo-text"], [1, "toggle-btn", 3, "click"], [1, "role-badge"], [1, "sidebar-nav"], ["routerLinkActive", "active", "matTooltipPosition", "after", 1, "nav-item", 3, "routerLink", "matTooltip"], [1, "sidebar-divider"], [1, "material-icons-round", "nav-icon"], [1, "nav-label"], [1, "sidebar-user"], [1, "user-avatar-sidebar"], [1, "user-info"], [1, "user-name"], [1, "user-email"], ["mat-icon-button", "", "matTooltip", "D\u00E9connexion", 1, "logout-btn", 3, "click"], [1, "main-area"], [1, "topbar"], [1, "topbar-left"], [1, "mobile-menu-btn", 3, "click"], [1, "topbar-right"], ["mat-icon-button", "", "matBadgeColor", "warn", "matBadgeSize", "small", 1, "icon-btn", 3, "routerLink", "matBadge"], ["mat-icon-button", "", "matBadgeColor", "warn", "matBadgeSize", "small", 1, "icon-btn", 3, "click", "matBadge"], ["mat-button", "", 1, "user-menu-btn", 3, "matMenuTriggerFor"], [1, "user-avatar-top"], [1, "topbar-username"], ["mat-menu-item", "", 3, "routerLink"], ["mat-menu-item", "", 3, "click"], [1, "page-content"], [1, "role-label"]], template: function UserLayoutComponent_Template(rf, ctx) { if (rf & 1) {
