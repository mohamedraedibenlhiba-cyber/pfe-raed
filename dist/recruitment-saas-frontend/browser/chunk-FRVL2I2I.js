...
// src/app/features/enterprise/offer-form/offer-form.component.ts
function OfferFormComponent_Conditional_12_Template(rf, ctx) {
  if (rf & 1) {
...
function OfferFormComponent_Conditional_13_Conditional_55_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-error");
    \u0275\u0275text(1, "Minimum 50 caract\xE8res");
    \u0275\u0275elementEnd();
  }
}
function OfferFormComponent_Conditional_13_Conditional_84_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "mat-spinner", 34);
  }
}
function OfferFormComponent_Conditional_13_Conditional_85_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(ctx_r1.isEdit ? "save" : "publish");
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r1.isEdit ? "Enregistrer" : "Cr\xE9er l'offre", " ");
  }
}
function OfferFormComponent_Conditional_13_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "form", 8);
    \u0275\u0275listener("ngSubmit", function OfferFormComponent_Conditional_13_Template_form_ngSubmit_0_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.submit());
    });
    \u0275\u0275elementStart(1, "h3", 9);
    \u0275\u0275text(2, "Informations principales");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 10)(4, "mat-form-field", 11)(5, "mat-label");
    \u0275\u0275text(6, "Titre du poste *");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(13, "place");
    \u0275\u0275elementEnd()();
    \u0275\u0275element(14, "app-select", 15);
    \u0275\u0275elementStart(15, "mat-form-field")(16, "mat-label");
    \u0275\u0275text(17, "Salaire minimum (\u20AC/an)");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(29, "Exp\xE9rience requise (ann\xE9es)");
    \u0275\u0275elementEnd();
    \u0275\u0275element(30, "input", 18);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(31, "mat-form-field")(32, "mat-label");
    \u0275\u0275text(33, "Date limite de candidature");
    \u0275\u0275elementEnd();
    \u0275\u0275element(34, "input", 19);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(35, "mat-form-field")(36, "mat-label");
    \u0275\u0275text(37, "Date de d\xE9but souhait\xE9e");
    \u0275\u0275elementEnd();
    \u0275\u0275element(38, "input", 20);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(39, "mat-form-field")(40, "mat-label");
    \u0275\u0275text(41, "Nombre de postes");
    \u0275\u0275elementEnd();
    \u0275\u0275element(42, "input", 21);
    \u0275\u0275elementStart(43, "mat-icon", 14);
    \u0275\u0275text(44, "group");
    \u0275\u0275elementEnd()();
    \u0275\u0275element(45, "app-select", 22);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(46, "div", 23)(47, "mat-checkbox", 24);
    \u0275\u0275text(48, "Poste en t\xE9l\xE9travail (partiel ou total)");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(49, "h3", 9);
    \u0275\u0275text(50, "D\xE9tails de l'offre");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(51, "mat-form-field")(52, "mat-label");
    \u0275\u0275text(53, "Description du poste *");
    \u0275\u0275elementEnd();
    \u0275\u0275element(54, "textarea", 25);
    \u0275\u0275template(55, OfferFormComponent_Conditional_13_Conditional_55_Template, 2, 0, "mat-error");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(56, "mat-form-field")(57, "mat-label");
    \u0275\u0275text(58, "Exigences du poste");
    \u0275\u0275elementEnd();
    \u0275\u0275element(59, "textarea", 26);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(60, "mat-form-field")(61, "mat-label");
    \u0275\u0275text(62, "Comp\xE9tences requises (pour le scoring IA)");
    \u0275\u0275elementEnd();
    \u0275\u0275element(63, "input", 27);
    \u0275\u0275elementStart(64, "mat-hint");
    \u0275\u0275text(65, "Ces comp\xE9tences servent au matching IA avec les candidats");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(66, "mat-form-field")(67, "mat-label");
    \u0275\u0275text(68, "Stack technique");
    \u0275\u0275elementEnd();
    \u0275\u0275element(69, "input", 28);
    \u0275\u0275elementStart(70, "mat-hint");
    \u0275\u0275text(71, "Technologies utilis\xE9es dans l'entreprise");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(72, "mat-form-field")(73, "mat-label");
    \u0275\u0275text(74, "Avantages (benefits)");
    \u0275\u0275elementEnd();
    \u0275\u0275element(75, "textarea", 29);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(76, "mat-form-field")(77, "mat-label");
    \u0275\u0275text(78, "Processus d'entretien");
    \u0275\u0275elementEnd();
    \u0275\u0275element(79, "textarea", 30);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(80, "div", 31)(81, "a", 32);
    \u0275\u0275text(82, "Annuler");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(83, "button", 33);
    \u0275\u0275template(84, OfferFormComponent_Conditional_13_Conditional_84_Template, 1, 0, "mat-spinner", 34)(85, OfferFormComponent_Conditional_13_Conditional_85_Template, 3, 2);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    let tmp_4_0;
    ...
    \u0275\u0275advance(14);
    \u0275\u0275property("options", ctx_r1.contractTypeOpts);
    \u0275\u0275advance(31);
    \u0275\u0275property("options", ctx_r1.experienceLevelOpts);
    \u0275\u0275advance(10);
    \u0275\u0275conditional(55, ((tmp_4_0 = ctx_r1.form.get("description")) == null ? null : tmp_4_0.hasError("minlength")) && ((tmp_4_0 = ctx_r1.form.get("description")) == null ? null : tmp_4_0.touched) ? 55 : -1);
    \u0275\u0275advance(28);
    \u0275\u0275property("disabled", ctx_r1.form.invalid || ctx_r1.saving);
    \u0275\u0275advance();
    \u0275\u0275conditional(84, ctx_r1.saving ? 84 : 85);
  }
}
var OfferFormComponent = class _OfferFormComponent {
  ...
  ngOnInit() {
    this.editId = this.route.snapshot.paramMap.get("id") ? +this.route.snapshot.paramMap.get("id") : void 0;
  ...
  submit() {
    ...
    const req = __spreadProps(__spreadValues({}, raw), {
      deadlineDate: raw.deadlineDate instanceof Date ? raw.deadlineDate.toISOString().split("T")[0] : raw.deadlineDate ?? null,
      startDate: raw.startDate instanceof Date ? raw.startDate.toISOString().split("T")[0] : raw.startDate ?? null
    });
    const obs = this.isEdit && this.editId ? this.offerSvc.update(this.editId, req) : this.offerSvc.create(req);
    obs.subscribe({
      next: () => {
        this.saving = false;
        this.snack.open(this.isEdit ? "Offre mise \xE0 jour" : "Offre cr\xE9\xE9e", "OK", { panelClass: "success-snack" });
  ...
  static {
    this.\u0275fac = function OfferFormComponent_Factory(t) {
      return new (t || _OfferFormComponent)();
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _OfferFormComponent, selectors: [["app-offer-form"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 14, vars: 3, consts: [[1, "form-page"], [1, "page-header"], [1, "page-title"], [1, "page-subtitle"], ["mat-button", "", "routerLink", "/enterprise/offers", 1, "back-btn"], [1, "card", "form-card"], [1, "loading-center"], ["diameter", "40"], ["novalidate", "", 3, "ngSubmit", "formGroup"], [1, "form-section-title"], [1, "form-grid"], [1, "full"], ["matInput", "", "formControlName", "title", "placeholder", "ex: D\xE9veloppeur Full-Stack Senior"], ["matInput", "", "formControlName", "location", "placeholder", "Paris, France"], ["matPrefix", ""], ["label", "Type de contrat", "formControlName", "contractType", 3, "options"], ["matInput", "", "formControlName", "salaryMin", "type", "number"], ["matInput", "", "formControlName", "salaryMax", "type", "number"], ["matInput", "", "formControlName", "experienceRequired", "type", "number", "min", "0"], ["matInput", "", "formControlName", "deadlineDate", "type", "date"], ["matInput", "", "formControlName", "startDate", "type", "date"], ["matInput", "", "formControlName", "numberOfPositions", "type", "number", "min", "1"], ["label", "Niveau d'exp\xE9rience", "formControlName", "experienceLevel", 3, "options"], [1, "checkbox-row"], ["formControlName", "remote"], ["matInput", "", "formControlName", "description", "rows", "6", "placeholder", "D\xE9crivez le poste, les responsabilit\xE9s, le contexte de l'\xE9quipe..."], ["matInput", "", "formControlName", "requirements", "rows", "3", "placeholder", "Qualifications, dipl\xF4mes, exp\xE9riences requises..."], ["matInput", "", "formControlName", "requiredSkills", "placeholder", "Angular, Spring Boot, Docker, AWS... (s\xE9par\xE9es par des virgules)"], ["matInput", "", "formControlName", "techStack", "placeholder", "React, Node.js, PostgreSQL, Kubernetes..."], ["matInput", "", "formControlName", "benefits", "rows", "3", "placeholder", "Mutuelle premium, titres-restaurant, 2 jours de t\xE9l\xE9travail/semaine, RTT..."], ["matInput", "", "formControlName", "interviewProcess", "rows", "3", "placeholder", "Ex : 1) Appel RH 30 min \u2192 2) Test technique \u2192 3) Entretien technique \u2192 4) Entretien RH final"], [1, "form-actions"], ["mat-stroked-button", "", "routerLink", "/enterprise/offers"], ["mat-flat-button", "", "type", "submit", 1, "btn-primary", 3, "disabled"], ["diameter", "20"]], template: function OfferFormComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275template(12, OfferFormComponent_Conditional_12_Template, 2, 0, "div", 6)(13, OfferFormComponent_Conditional_13_Template, 86, 6);
        \u0275\u0275elementEnd()();
      }
      if (rf & 2) {
        \u0275\u0275advance(4);
        \u0275\u0275textInterpolate(ctx.isEdit ? "Modifier l'offre" : "Nouvelle offre d'emploi");
        \u0275\u0275advance(2);
        \u0275\u0275textInterpolate(ctx.isEdit ? "Mettez \xE0 jour les informations de l'offre" : "Cr\xE9ez et publiez votre offre d'emploi");
        \u0275\u0275advance(6);
        \u0275\u0275conditional(12, ctx.loading ? 12 : 13);
      }
    }, dependencies: [CommonModule, ReactiveFormsModule, \u0275NgNoValidate, DefaultValueAccessor, NumberValueAccessor, NgControlStatus, NgControlStatusGroup, MinValidator, FormGroupDirective, FormControlName, RouterLink, MatButtonModule, MatAnchor, MatButton, MatIconModule, MatIcon, MatFormFieldModule, MatFormField, MatLabel, MatHint, MatError, MatPrefix, MatInputModule, MatInput, AppSelectComponent, MatCheckboxModule, MatCheckbox, MatSnackBarModule, MatProgressSpinnerModule, MatProgressSpinner, MatDatepickerModule, MatNativeDateModule], styles: ["\n\n.page-header[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: flex-start;\n  justify-content: space-between;\n  margin-bottom: 20px;\n}\n.back-btn[_ngcontent-%COMP%] {\n  color: var(--text-secondary) !important;\n}\n.loading-center[_ngcontent-%COMP%] {\n  display: flex;\n  justify-content: center;\n  padding: 80px;\n}\n.form-card[_ngcontent-%COMP%] {\n  max-width: 780px;\n}\n.form-section-title[_ngcontent-%COMP%] {\n  font-size: 0.875rem;\n  font-weight: 600;\n  color: var(--text-secondary);\n  text-transform: uppercase;\n  letter-spacing: 0.06em;\n  margin: 20px 0 8px;\n  padding-bottom: 8px;\n  border-bottom: 1px solid var(--border-color);\n}\n.form-grid[_ngcontent-%COMP%] {\n  display: grid;\n  grid-template-columns: 1fr 1fr;\n  gap: 0 16px;\n}\n.form-grid[_ngcontent-%COMP%]   .full[_ngcontent-%COMP%] {\n  grid-column: 1/-1;\n}\n@media (max-width: 600px) {\n  .form-grid[_ngcontent-%COMP%] {\n    grid-template-columns: 1fr;\n  }\n}\n.checkbox-row[_ngcontent-%COMP%] {\n  margin: 4px 0 12px;\n}\n.form-actions[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  justify-content: flex-end;\n  gap: 12px;\n  margin-top: 20px;\n  padding-top: 16px;\n  border-top: 1px solid var(--border-color);\n}\n/*# sourceMappingURL=offer-form.component.css.map */"] });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(OfferFormComponent, { className: "OfferFormComponent", filePath: "src\\app\\features\\enterprise\\offer-form\\offer-form.component.ts", lineNumber: 25 });
})();
export {
  OfferFormComponent
};
//# sourceMappingURL=chunk-FRVL2I2I.js.map
