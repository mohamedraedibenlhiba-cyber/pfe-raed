...
export const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'interviews', loadComponent: () => import('./features/enterprise/interviews/enterprise-interviews.component').then(m => m.EnterpriseInterviewsComponent), title: 'Mes entretiens' },
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'interviews', loadComponent: () => import('./features/candidate/interviews/candidate-interviews.component').then(m => m.CandidateInterviewsComponent), title: 'Mes entretiens' },
