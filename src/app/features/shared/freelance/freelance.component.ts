...
@if (negotiatingBid) {
  ...
  --shadow-strong: 0 24px 52px rgba(15, 23, 42, 0.10);
...
.hero-card {
  ...
  gap: 28px;
  background:
    radial-gradient(circle at 74% 8%, rgba(255,255,255,.06) 0 11%, transparent 12%),
    radial-gradient(circle at 66% 74%, rgba(255,255,255,.07) 0 13%, transparent 14%),
    linear-gradient(135deg, #071a3d 0%, #10265b 48%, #071a3d 100%);
  color: #fff;
...
.btn-primary {
  ...
  &:hover:not(:disabled) {
    ...
    box-shadow: 0 20px 38px rgba(245, 196, 0, 0.3);
  }
  ...
  mat-spinner {
    --mdc-circular-progress-active-indicator-color: #1a2b5f;
  }
}
