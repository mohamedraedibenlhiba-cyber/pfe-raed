...
import { ApiResponse, Comment, Page, Post, FilePreview } from '../models/models';
...
export class PostService {
  ...
  // ✨ Attachements
  uploadPostAttachment(postId: number, file: File): Observable<ApiResponse<void>> {
    const formData = new FormData();
    formData.append('file', file);
    return this.http.post<ApiResponse<void>>(`${this.API}/${postId}/attachment`, formData);
  }

  removePostAttachment(postId: number): Observable<ApiResponse<void>> {
    return this.http.delete<ApiResponse<void>>(`${this.API}/${postId}/attachment`);
  }

  uploadCommentAttachment(commentId: number, file: File): Observable<ApiResponse<void>> {
    const formData = new FormData();
    formData.append('file', file);
    return this.http.post<ApiResponse<void>>(`${this.API}/comments/${commentId}/attachment`, formData);
  }

  removeCommentAttachment(commentId: number): Observable<ApiResponse<void>> {
    return this.http.delete<ApiResponse<void>>(`${this.API}/comments/${commentId}/attachment`);
  }
